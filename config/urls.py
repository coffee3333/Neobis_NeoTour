...
urlpatterns = [
    ...
    re_path(r'^neotour/swagger/$', schema_view.with_ui('swagger', cache_timeout=0), name='schema-swagger-ui'),
    re_path(r'^redoc/$', schema_view.with_ui('redoc', cache_timeout=0), name='schema-redoc'),
    path('neotour/users/', include('authentication.urls')),
    path('neotour/tour/', include('neotour.urls')),
    path('neotour/admin/', admin.site.urls),
]
